...
class Fabric2COCO:
    ...
    def _cp_img(self, img_path):
        shutil.copy(img_path, os.path.join("/home/aistudio/PaddleDetection/dataset/coco/{}".format(self.is_mode),
...
'''转换为coco格式'''
#训练集,划分90%做为训练集
img_dir = '../data/3_images/'
anno_dir= '../data/annotations/train_converted.json'
fabric2coco = Fabric2COCO()
train_instance = fabric2coco.to_coco(anno_dir,img_dir)
fabric2coco.save_coco_json(train_instance, "../data/annotations/"+'instances_{}.json'.format("train"))
...
train_instance = fabric2coco.to_coco(anno_dir,img_dir)
fabric2coco.save_coco_json(train_instance, "../data/annotations/"+'instances_{}.json'.format("val"))