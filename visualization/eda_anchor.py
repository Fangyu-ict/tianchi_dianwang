...
#https://zhuanlan.zhihu.com/p/108885033
...
# 读取数据
ann_json = './data/annotations/train_annos_coco_0608.json'
...
# 绘图
wh_df = pd.DataFrame(box_wh_count[:],index=box_wh_unique[:],columns=['the number of w/h'])#宽高比数量
