...
src_base_path = '/home/sdc/yufang2/competition/dianwang/data/anno'
src_json_file = os.path.join(src_base_path, "train_converted2.json")

save_train_json_path = os.path.join(src_base_path, "train_0208.json")
save_val_json_path = os.path.join(src_base_path, "val_0208.json")
...
class_split_ratio_max = 0.15  # 每一类在验证集的object个数不能多于0.22
#########
